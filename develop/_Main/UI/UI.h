...
extern ALLEGRO_FONT* bold_font;//�����
extern ALLEGRO_FONT* compcolor_font;//������
...
void draw_bold_text(ALLEGRO_FONT* font, ALLEGRO_COLOR main_color, ALLEGRO_COLOR outline_color, float x, float y, int flags, int thickness, const char* text); //0328 �躴�� ����ü �ۼ� �Լ�
