...
{
    MENU m = { BUFFER_W / 2, BUFFER_H / 2, 250, 300, {"Start Game", "How to play", "Ranking", "Exit"}, 4, current_menu_selection };//0328 ±èº´Çå howtoplay Ãß°¡
...
void ui_draw_h2p_menu() // 0330 ±èº´Çå
{
    ...
    // 2. ¹è°æ ±×¸®±â (È­¸éÀÇ (0,0) À§Ä¡ºÎÅÍ (BUFFER_W, BUFFER_H) Å©±â·Î È®Àå)
    if (bg_image) {
        al_draw_tinted_scaled_bitmap(
            bg_image,            // ºñÆ®¸Ê Æ÷ÀÎÅÍ
            al_map_rgb(50, 50, 50), // Æ¾Æ® ÄÃ·¯
